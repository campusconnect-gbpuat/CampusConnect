...
export const NoticeModal = ({
    ...
    const [content, setContent] = useState(notice === undefined ? "" : notice.content)
    ...
    const handleForm = async (e) => {
        ...
        // console.log(formData);
        notice
            ? noticeFunction({ description: content, title, link }, authContext.user._id, notice._id)
            : noticeFunction({ description: content, title, link }, authContext.user._id)
        handleModal()
    }
    const styleTheme =
