      ...
      <ThemeProvider theme={theme}>
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/notices" element={<PrivateRoute component={Notice} />} />
            <Route path="/about-university" element={<PrivateRoute component={AboutUniversity} />} />
            <Route path="/settings-privacy" element={<PrivateRoute component={SettingsPrivacy} />} />
            <Route path="/feedback" element={<PrivateRoute component={Feedback} />} />
            <Route path="/help-support" element={<PrivateRoute component={HelpSupport} />} />
          </Routes>
        </BrowserRouter>
      </ThemeProvider>
    </div>
